...
CREATE TABLE IF NOT EXISTS `row_stitch`
(
    `row_stitch_id`    INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    `row_id`           INTEGER                           NOT NULL,
    `ordinal_position` INTEGER                           NOT NULL,
    FOREIGN KEY (`row_id`) REFERENCES `row` (`row_id`) ON UPDATE NO ACTION ON DELETE NO ACTION
);
